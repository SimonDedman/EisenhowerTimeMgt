...
```{r combined-matrix, results='asis'}
cat('<img src="eisenhower_matrix_combined.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Combined Eisenhower Matrix" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
```
...
```{r combined-timeline, results='asis'}
cat('<img src="task_timeline.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Task Timeline" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
```
...
```{r work-matrix, results='asis'}
if (!is.null(work_eisenhower_plot)) {
  cat('<img src="eisenhower_matrix_work.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Work Eisenhower Matrix" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
} else {
  cat("No work tasks available. Add tasks to Marine Calendar or MarSci Projects Trello board.")
}
```
...
```{r work-timeline, results='asis'}
if (!is.null(work_timeline_plot)) {
  cat('<img src="task_timeline_work.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Work Timeline" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
} else {
  cat("No work timeline available")
}
```
...
```{r home-matrix, results='asis'}
if (!is.null(home_eisenhower_plot)) {
  cat('<img src="eisenhower_matrix_home.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Home Eisenhower Matrix" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
} else {
  cat("No home tasks available.")
}
```
...
```{r home-timeline, results='asis'}
if (!is.null(home_timeline_plot)) {
  cat('<img src="task_timeline_home.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Home Timeline" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">')
} else {
  cat("No home timeline available")
}
```
