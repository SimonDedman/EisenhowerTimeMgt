...
```{r combined-matrix, results='asis', echo=FALSE}
...
```{r combined-timeline, results='asis', echo=FALSE}
...
```{r work-matrix, results='asis', echo=FALSE}
...
```{r work-timeline, results='asis', echo=FALSE}
if (nrow(work_task_data) > 0) {
...
```{r home-matrix, results='asis', echo=FALSE}
...
```{r home-timeline, results='asis', echo=FALSE}
if (nrow(home_task_data) > 0) {
