...
<img src="eisenhower_matrix_combined.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Combined Eisenhower Matrix" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">
...
<img src="task_timeline.png" class="clickable-image" onclick="openImageModal(this.src, this.alt)" alt="Task Timeline" style="max-width: 100%; cursor: pointer;" title="Click to enlarge">
